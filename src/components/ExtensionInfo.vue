...
<template>
    <div class="bg-neutral-0 dark:bg-neutral-800 dark:text-neutral-0 p-4 rounded-2xl drop-shadow-md dark:border-1 dark:border-neutral-500 relative h-48">
        ...
        <div class="flex justify-between lg:pt-12 items-center absolute bottom-4 w-full pr-8 ">
            <button @click="removeExtension(extension.name)" class="hover:bg-red-500 hover:text-white hover:border-red-500 dark:hover:text-neutral-900">Remove</button>
